...
public class ScrollingTextVerticalReverse : MonoBehaviour
{
    public float speed = 50f; // Tốc độ di chuyển
    public RectTransform textTransform; // RectTransform của Text
    public float startPositionY = -500f; // Vị trí bắt đầu (dưới cùng)
    public float endPositionY = 500f;  // Vị trí kết thúc (trên cùng)
    ...
    private void Update()
    {
        ...
        {
            // Đặt lại Text gốc phía dưới phần tử cuối cùng
        ...
        for (int i = 0; i < duplicateTextTransforms.Length; i++)
        {
            ...
            {
                // Đặt lại Text sao chép phía dưới phần tử cuối cùng
